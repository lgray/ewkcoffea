...
def put_s_over_root_b(yld_dict):
    ...
    sig_sum = {"sr_4l_sf_A":[0,None], "sr_4l_sf_B":[0,None], "sr_4l_sf_C":[0,None], "sr_4l_of_1":[0,None], "sr_4l_of_2":[0,None], "sr_4l_of_3":[0,None], "sr_4l_of_4":[0,None]}
    bkg_sum = {"sr_4l_sf_A":[0,None], "sr_4l_sf_B":[0,None], "sr_4l_sf_C":[0,None], "sr_4l_of_1":[0,None], "sr_4l_of_2":[0,None], "sr_4l_of_3":[0,None], "sr_4l_of_4":[0,None]}
    for proc in yld_dict.keys():
        print(proc)
        for cat in yld_dict[proc].keys():
    ...
    for cat in sig_sum.keys():
        s_over_root_b = sig_sum[cat][0]/np.sqrt(bkg_sum[cat][0])
        out[cat] = [s_over_root_b,None]
    yld_dict[SOVERROOTB] = out
...
def print_yields(yld_dict,print_fom=True):
    ...
    if print_fom: procs_to_print.append(SOVERROOTB)
